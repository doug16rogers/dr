...
; -----------------------------------------------------------------------------
(defun dr-insert-mandiant-copyright ()
  "Inserts Mandiant's copyright notice."
  (goto-char 1)
  (insert "\n")
  (forward-line -1)
  (dr-insert-comment-start-space)
...
(global-set-key "\C-cm"    'dr-insert-doxygen-main-header)
(global-set-key "\C-cM"    'dr-insert-main-c-program)
