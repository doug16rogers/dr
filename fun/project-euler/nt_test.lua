...
-- Test nt.gcd()
assert(equal(0, nt.gcd(0, 0)))
assert(equal(0, nt.gcd(0, 1)))
assert(equal(1, nt.gcd(1, 1)))
assert(equal(1, nt.gcd(-1, 1)))
assert(equal(1, nt.gcd(1, -1)))
assert(equal(1, nt.gcd(-1, -1)))
assert(equal(2, nt.gcd(-2, 4)))
assert(equal(2, nt.gcd(2, 6)))
assert(equal(1, nt.gcd(81, 17)))
assert(equal(9, nt.gcd(81, 9)))
assert(equal(9, nt.gcd(36, 81)))
assert(equal(1, nt.gcd(76393, 16384)))
