...
%%                                              +---+---+---+---+---+
%%   Place one of A, B, C, or                 A | 0 | 1 | 3 | 2 | 2 |
%%   D into each of the 25                       +---+---+---+---+---+
%%   empty cells so that the                  B | 2 | 2 | 1 | 2 | 0 |
%%   number of letters in each                  +---+---+---+---+---+
%%   row and column is as                     C | 2 | 1 | 0 | 1 | 1 |
%%   indicated by the numbers.                  +---+---+---+---+---+
%%   Identical letters cannot     A   B   C   D | 1 | 1 | 1 | 0 | 2 |
%%   be next to each other      +---+---+---+---+---+---+---+---+---+
%%   horizontally or            | 1 | 2 | 1 | 1 |   |   |   |   |   |
%%   vertically.                +---+---+---+---+---+---+---+---+---+
%%                              | 1 | 1 | 2 | 1 |   |   |   |   |   |
%%                              +---+---+---+---+---+---+---+---+---+
%%                              | 2 | 0 | 2 | 1 |   |   |   |   |   |
...
%% legal_board([[2,1,0,1,3],[1,2,3,0,2],[2,3,0,2,0],[1,0,1,0,3],[3,1,0,1,0]]).

abcd_col_counts([[0,2,2,1],[1,2,1,1],[3,1,0,1],[2,2,1,0],[2,0,1,2]]).
abcd_row_counts([[1,2,1,1],[1,1,2,1],[2,0,2,1],[2,2,0,1],[2,2,0,1]]).
%% abcd_value_count(4).
